...
namespace MaratonandoApp.Server.Migrations
{
    ...
    [Migration("20210725165824_ultimaAtt")]
    partial class ultimaAtt
    {
            ...
            modelBuilder.Entity("MaratonandoApp.Shared.Models.Series.Episode", b =>
                {
                    ...
                    b.HasOne("MaratonandoApp.Shared.Models.Series.SerieOnLibrary", null)
                        .WithMany("episodes")
                        .HasForeignKey("SerieOnLibraryId");
